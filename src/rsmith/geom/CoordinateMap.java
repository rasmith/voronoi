...
public class CoordinateMap {
	...
	private void init() {
		xmap = createSegmentMap(	sourceRect.getX(), sourceRect.getX() + sourceRect.getWidth(),
															destRect.getX(), destRect.getX() + destRect.getWidth() );
		ymap = createSegmentMap(	sourceRect.getY(), sourceRect.getY() - sourceRect.getHeight(),
															destRect.getY(), destRect.getY() - destRect.getHeight() );
	}
